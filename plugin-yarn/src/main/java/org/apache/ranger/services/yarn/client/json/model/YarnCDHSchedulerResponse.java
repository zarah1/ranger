...
public class YarnCDHSchedulerResponse extends YarnSchedulerResponse implements java.io.Serializable {
...
//
//        public YarnRootQueue getRootQueue() { return rootQueue; }
//
//
//        public void collectQueueNames(List<String> queueNames) {
//            if(rootQueue != null) {
...
//    }
    ...
    public static class YarnRootQueue implements java.io.Serializable {
        ...
        public YarnChildQueues getChildQueues() { return childQueues; }
    ...
    public static class YarnChildQueues implements java.io.Serializable {
        ...
        public List<YarnRootQueue> getQueue() { return queue; }
